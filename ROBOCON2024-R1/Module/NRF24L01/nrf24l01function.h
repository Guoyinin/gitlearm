...
typedef struct 
{
	SPI_HandleTypeDef* bsp_nrf24l01_spi;
	
	GPIO_TypeDef*      bsp_nrf24l01_chip_select_port;
	uint32_t           bsp_nrf24l01_chip_select_pin;
									  
	GPIO_TypeDef*      bsp_nrf24l01_chip_enable_port;
	uint32_t           bsp_nrf24l01_chip_enable_pin;
									  
	GPIO_TypeDef*      bsp_nrf24l01_chip_iqr_port;
	uint32_t           bsp_nrf24l01_chip_iqr_pin;
}bsp_nrf24l01_t;

/* 定义NRF24L01对象类型 */
struct nrf24l01 {
  uint8_t reg[8];                                            //记录前8个配置寄存器
	bsp_nrf24l01_t bsp_nrf24l01;                               // nrf24l01的 硬件配置
  uint8_t (*ReadWriteByte)(nrf24l01_t* nrf, uint8_t TxData); //声明向nRF24L01读写一个字节的函数
  void (*ChipSelect)(nrf24l01_t* nrf, NRF24L01CSType cs);    //声明片选操作函数
  void (*ChipEnable)(nrf24l01_t* nrf, NRF24L01CEType en);    //声明使能及模式操作函数
  uint8_t (*GetIRQ)(nrf24l01_t* nrf);                        //声明中断获取函数
  void (*Delayms)(volatile uint32_t nTime);                  //毫秒延时操作指针
};

typedef uint8_t (*NRF24L01ReadWriteByte)(nrf24l01_t* nrf, uint8_t TxData);//声明向nRF24L01读写一个字节的函数
typedef void (*NRF24L01ChipSelect)(nrf24l01_t* nrf, NRF24L01CSType cs);//声明片选操作函数
typedef void (*NRF24L01ChipEnable)(nrf24l01_t* nrf, NRF24L01CEType en);//声明使能及模式操作函数
typedef uint8_t (*NRF24L01GetIRQ)(nrf24l01_t* nrf);//声明中断获取函数
